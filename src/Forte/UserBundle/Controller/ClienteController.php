...
namespace Forte\UserBundle\Controller;

use Symfony\Component\HttpFoundation\Request;
use Symfony\Bundle\FrameworkBundle\Controller\Controller;

use Forte\UserBundle\Entity\Cliente;
use Forte\UserBundle\Form\ClienteType;
...
class ClienteController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('UserBundle:Cliente')->findAll();

        return $this->render('UserBundle:Cliente:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('UserBundle:Cliente:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('UserBundle:Cliente')->find($id);
        ...
        return $this->render('UserBundle:Cliente:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('UserBundle:Cliente:edit.html.twig', array(
            'entity'      => $entity,
