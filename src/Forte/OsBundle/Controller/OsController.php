...
use Forte\OsBundle\Form\OsType;
...
class OsController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('OsBundle:Os')->findAll();

        return $this->render('OsBundle:Os:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('OsBundle:Os:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('OsBundle:Os')->find($id);

        $reparo = $entity->getReparos();
        ...
        return $this->render('OsBundle:Os:show.html.twig', array(
            'entity'      => $entity,
            'reparo'      => $reparo,  
    ...
    public function editAction($id)
    {
        ...
        return $this->render('OsBundle:Os:edit.html.twig', array(
            'entity'      => $entity,
