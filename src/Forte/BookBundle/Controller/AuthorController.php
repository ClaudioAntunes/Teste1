...
use Forte\BookBundle\Entity\Author;
use Forte\BookBundle\Form\AuthorType;
...
class AuthorController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ForteBookBundle:Author')->findAll();
     ...
     * @Method("POST")
     * @Template("ForteBookBundle:Author:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ForteBookBundle:Author')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ForteBookBundle:Author:edit.html.twig")
     */
