...
use Forte\BookBundle\Entity\Book;
use Forte\BookBundle\Form\BookType;
...
class BookController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ForteBookBundle:Book')->findAll();
        $entities2 = $em->getRepository('ForteBookBundle:Addr')->findAll();
     ...
     * @Method("POST")
     * @Template("ForteBookBundle:Book:new.html.twig")
     */
...
#     #   $em = $this->getDoctrine()->getManager();
#
#        $entity = $em->getRepository('ForteBookBundle:Book')->find($id);
#        $rua = $entity->getEndereco();
...
#
        ...
        ->getRepository('ForteBookBundle:Book')
        ->findOneByIdJoinedToEndereco($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ForteBookBundle:Book:edit.html.twig")
     */
